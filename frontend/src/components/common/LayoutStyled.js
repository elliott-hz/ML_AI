...
/** Page-level container with max-width and centered content */
...
/** Formula / definition box with left accent border */
...
/** Formula box sub-title (h3) */
export const FormulaTitle = styled.h3`
  color: ${({ theme }) => theme?.colors?.textPrimary || '#f8fafc'};
  font-size: 18px;
  font-weight: 600;
