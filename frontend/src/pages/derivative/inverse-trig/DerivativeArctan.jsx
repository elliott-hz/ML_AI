...
const DerivativeArctan = () => {
  ...
  const formulaInTitle = "(arctan x)' = 1 / (1 + x\u00B2)";
  ...
  return (
    <PageContainer>
      <Header>
        ...
        <SectionTitleH1>Arctangent Function</SectionTitleH1>
      </Header>

      <SectionDescription>
        The derivative of arctan x is 1/(1 + x²). Unlike arcsin and arccos, arctan is defined for all
        real numbers. Its derivative forms a bell-shaped curve that peaks at x = 0 with value 1,
        and decays to 0 as x → ±∞.
      </SectionDescription>

      <FormulaBox>
        <FormulaTitle>Derivative of Arctangent:</FormulaTitle>
        <Formula>
          f(x) = arctan x &nbsp;&nbsp;x ∈ (-∞, ∞)<br/><br/>
          f'(x) = 1 / (1 + x²)
        </Formula>
      </FormulaBox>
...
export default DerivativeArctan;
